module ApplicationHelper
    ...
    if current_user.is_a?(GuestUser) #checking class type of current user
  ...
  def alert_generator msg
    js add_gritter(msg, :title => "Przemek Zastawny Portfolio", :sticky => false, :class_name => "custom_gritter")
  end
